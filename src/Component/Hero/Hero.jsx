      ...
      <div className={styles.container}>
        <div className={styles.hero_content}>
          <div className={styles.hero_info}>
            ...
            <h3 className={styles.text_2}>Kittiphob Saibunyang</h3>
            ...
            <ul className={styles.hero_social}>
              <li>
                <a href="https://www.facebook.com/kittipop.joe">
                  <FaFacebookF />
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/kittiphob_joe/?hl=th">
                  <FaInstagram />
                </a>
              </li>
              <li>
                <a href="https://github.com/KittiphobJoe">
                  <FaGithub />
                </a>
              </li>
            </ul>
          ...
          <div>
            <Tile scale={1.2} transitionSpeed={2500} tiltReverse={true}>
